<template>
    <div class="main-container">
      ...
      <header>
        ...
        <button @click="mostrarModal = true" class="btn-registrar">Registrar Vacuna</button>
      </header>
        ...
        <div class="modal-content">
          ...
          <form @submit.prevent="registrarVacuna" class="modal-form">
            <div class="form-group">
              ...
              <input id="nombre" v-model="nuevaVacuna.nombreVacuna" placeholder="Ej. Pentavalente" required />
            </div>
            <div class="form-group">
              <label for="fecha">Fecha de vacunación:</label>
              <input id="fecha" type="date" v-model="nuevaVacuna.fechaVacunacion" required />
            </div>
            <div class="form-group">
              <label for="dosis">Dosis:</label>
              <input id="dosis" v-model="nuevaVacuna.dosis" placeholder="Ej. 1/2/3" required />
            </div>
            <div class="form-group">
              <label for="centro">Centro de Salud:</label>
              <input id="centro" v-model="nuevaVacuna.centroSalud" placeholder="Ej. Hospital Central" required />
            </div>
    ...
    methods: {
      ...
      async registrarVacuna() {
        try {
          ...
          if (!response.ok) throw new Error('Error al registrar la vacuna');
      ...
      cerrarModal() {
        ...
        this.nuevaVacuna = { nombreVacuna: '', fechaVacunacion: '', dosis: '', centroSalud: '' };
      },
    },
    mounted() {
      this.cargarVacunas();
